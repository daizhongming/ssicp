<script setup>
  ...
  import instrumentManagemenManage from './InstrumentManagemenManage.vue';
        ...
        <template #table>
          ...
          >
            ...
            >
              <template #default="scope">
                {{
                  dictStore().pipeline_yibiao_type().label(scope.row.deviceType)
                }}
              </template>
            </el-table-column>
            <el-table-column
