<script setup>
  ...
  import ValveManagementManage from './ValveManagementManage.vue';
        ...
        <template #table>
          ...
          >
            ...
            >
              <template #default="scope">
                {{
                  dictStore().pipeline_famen_type().label(scope.row.deviceType)
                }}
              </template>
            </el-table-column>
            <el-table-column
