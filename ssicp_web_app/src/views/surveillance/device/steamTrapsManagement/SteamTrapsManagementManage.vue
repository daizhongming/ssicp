<script setup>
  ...
  async function radiook(pid) {
    ...
    if (inletOrexit.value === 'exit') {
      //出口
      console.log('出口');
      devicedto.deviceSteamTraps.locationDescription = pid;
    } else if (inletOrexit.value === 'inlet') {
      //进口
      console.log('进口');
      devicedto.deviceSteamTraps.pid = pid;
    } else {
      return;
    }
  }
...
<template>
  <FormCard title="疏水阀基本信息">
    <el-form label-width="100px">
      <el-row :gutter="16">
        <el-col :span="12">
          <el-form-item label="疏水阀编号" required>
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="疏水阀名称" required>
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="疏水阀类型" required>
            <el-select
              clearable
            ...
            >
              <el-option
                v-for="yali in dictStore().pipeline_steamtraps_type().all"
        ...
        <el-col :span="12">
          <el-form-item label="工作年限">
            <el-input
              v-model="devicedto.deviceSteamTraps.workYears"
              placeholder="请输入"
              minlength="3"
              maxlength="10"
              show-word-limit
        ...
        <el-col :span="12">
          <el-form-item label="投用日期">
            <el-date-picker
              clearable
              v-model="devicedto.deviceSteamTraps.useTime"
              type="date"
              label="请选择日期"
              placeholder="请选择日期"
            />
        ...
        <el-col :span="12">
          <el-form-item label="使用年限">
            <el-input
              v-model="devicedto.deviceSteamTraps.usageDuration"
              placeholder="请输入"
              minlength="3"
              maxlength="10"
              show-word-limit
        ...
        <el-col :span="12">
          <el-form-item label="检查周期">
            <el-input
              v-model="devicedto.deviceSteamTraps.checkPeriod"
              placeholder="请输入"
              minlength="3"
              maxlength="10"
              show-word-limit
        ...
        <el-col :span="12">
          <el-form-item label="质检日期">
            <el-date-picker
              clearable
              v-model="devicedto.deviceSteamTraps.qcDate"
              type="date"
              label="请选择日期"
              placeholder="请选择日期"
            />
  ...
  <FormCard title="连接管段信息">
    <el-form label-width="80px">
      <el-row :gutter="16">
        <el-col :span="12">
          <el-form-item label="所属管段" required>
            <el-input
              :value="inlet(devicedto.deviceSteamTraps.pid)"
              v-model="devicedto.deviceSteamTraps.pid"
              clearable
              readonly="readonly"
              @click="dadio(0, devicedto.deviceSteamTraps.pid)"
              placeholder="必填项"
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="安装位置" required>
            <el-input
              v-model="devicedto.deviceSteamTraps.locationDescription"
              clearable
              placeholder="必填项"
            />
          </el-form-item>
  ...
  <FormCard title="监测指标报警设置">
    <ParametersettingsManage
      ...
      :dictData="dictStore().steam_traps_index().all"
    />
  </FormCard>
